...
| `vibe-coding/` | 旧资源迁移占位，实际 AI 资源在 workspace 根 `AGENTS.md` 与 `.agents/skills/` |
...
- 不要把 vibe-coding 资源重新复制回 `blacksmith/vibe-coding/`；workspace 根 `AGENTS.md` 与 `.agents/skills/` 是单一来源。
