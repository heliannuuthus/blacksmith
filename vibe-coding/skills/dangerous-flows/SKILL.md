---
name: dangerous-flows
description: "Identify dangerous data flows and insecure patterns in code. Use when auditing code for security vulnerabilities, tracing untrusted input lifecycle, or reviewing for injection risks."
---
